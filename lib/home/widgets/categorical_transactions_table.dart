...
class CategoricalTransactionTable extends StatelessWidget {
  ...
  CategoricalTransactionTable(this.data, {super.key});
                    ...
                    ...List<DataRow>.generate(
                      ...
                      (index) => DataRow(
                        cells: [
                          DataCell(
                            Text(
                              formatDate(data.transactions[index].date, [
                                mm,
                                '-',
                                dd,
                                '-',
                          ...
                          DataCell(
                            Text(
                              data.transactions[index].type == 'B'
                          ...
                          DataCell(
                            Text(
                              data.transactions[index].type == 'S'
                                  ? data.transactions[index].quantity.toString()
                                  : '',
                            ),
                          ),
                          DataCell(
                            Text(data.transactions[index].price.toString()),
                          ),
                          DataCell(
                            Text(
                              data.transactions[index].type == 'B'
